...
impl KeyData {
    ...
    fn pack_vacant(index: buckets::Index<BUCKETS>, version: u32) -> Option<Self> {
        ...
        Some(Self {
            ...
            version: NonZero::new(Self::version_make_occupied(version)).unwrap(),
        })
    }
    ...
    fn pack_occupied(index: buckets::Index<BUCKETS>, version: u32) -> Option<Self> {
        ...
        Some(Self {
            index: buckets_index_as_u32(index),
            version: NonZero::new(version).unwrap(),
        })
    }
...
fn buckets_index_as_u32(index: buckets::Index<BUCKETS>) -> NonZero<u32> {
    ...
    unsafe { NonZero::new_unchecked(index.into_raw().get() as u32) }
}
